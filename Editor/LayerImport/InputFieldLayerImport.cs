...
namespace PSDUIImporter
{
    ...
    internal class InputFieldLayerImport : ILayerImport
    {
        ...
        {
            UnityEngine.UI.InputField temp = AssetDatabase.LoadAssetAtPath(PSD2UGUIConfig.ASSET_PATH_INPUTFIELD, typeof(UnityEngine.UI.InputField)) as UnityEngine.UI.InputField;
            UnityEngine.UI.InputField inputfield = GameObject.Instantiate(temp);
            ...
            for (int i = 0; i < layer.layers.Length; ++i)
            {
                ...
                if (_temp.image != null)
                {
                    ...
                    if (image.imageType == EImageType.Label)
                    {
                        ...
                        {
                            this.ctrl.DrawLayer(_temp, inputfield.gameObject);
